const COMMON_SELECT = `
    SELECT mds.sharing_id, mds.document_id, pmd.document_uuid, pmd.document_title, mds.patient_id, p.first_name as patient_first_name, p.last_name as patient_last_name, d.doctor_id, d.first_name as doctor_first_name, d.last_name as doctor_last_name, mds.note, mds.created_at
...
module.exports = {
  ...
  GET_DOCS_BY_PATIENT_ID: `
    SELECT medical_document_id, patient_medical_documents.patient_id, title, first_name, middle_name, last_name, document_uuid, patient_medical_documents.medical_document_id, document_title, mimetype, created_at, updated_at, COUNT(*) OVER() AS totalRows
    FROM patient_medical_documents
    INNER JOIN patients ON patient_medical_documents.patient_id = patients.patient_id
