...
INSERT INTO `appointment_payments` VALUES (2,44,200.000000,'SLL','ORNAGE MONEY','370aa17c-96ca-483b-9331-595f8345057d','MP240111.1534.B01385','v18zashucxteoguqgruq9zro1mfsogxiyhe3lb7d4kly9yf7prasuzaho5hobdkd','9amn8kjlnkd7wdkpbayjvwdeuzkjrklk','success','2024-01-11 14:33:25','2024-01-11 18:17:54'),(3,45,200.000000,'SLL','ORNAGE MONEY','958522ae-5814-446a-8823-799073dedbe8','MP240112.1445.B01416','v1ztyfiyqgiqzcehxjcpr491d33undsz7hcp21zmgy3hcebkhkhxybdhwlli5sii','5tirtultuj4hwxkaxa2omjx0pxyun7bg','success','2024-01-12 13:44:04','2024-01-12 13:45:58'),(4,46,200.000000,'SLL','ORNAGE MONEY','cf52d248-ced5-4422-887a-de7a4105be8e','MP240112.1518.B01420','v1cjonnxtbbhvc1nd6ufo9jlsub66fr1999brtqzqpvtwmawamff9vjmsxobe6yz','bv4kvwt0ksimn6xvbkggd81txrfnilog','success','2024-01-12 14:17:08','2024-01-12 14:18:56');
...
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `Sp_GetCities`()
BEGIN
    SELECT * FROM cities;
END ;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `Sp_GetMedicalAppointmentById`(
...
INNER JOIN medical_specialities as ms on medical_appointments.speciality_id = ms.speciality_id WHERE medical_appointments.appointment_id = p_appointment_id;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `Sp_GetMedicalAppointmentByUUID`(
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `Sp_GetMedicalAppointmentsByPatientId`(
IN p_patient_id INT
)
BEGIN
SELECT appointment_id,appointment_uuid,
...
INNER JOIN patients as p on medical_appointments.patient_id = p.patient_id
INNER JOIN doctors as d on medical_appointments.doctor_id = d.doctor_id
INNER JOIN medical_specialities as ms on medical_appointments.speciality_id = ms.speciality_id WHERE medical_appointments.patient_id = p_patient_id;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `Sp_GetPatientMedicalAppointmentById`(
IN p_patient_id INT,
    IN p_appointment_id INT
)
BEGIN
...
-- Dump completed on 2024-01-12 15:58:44
