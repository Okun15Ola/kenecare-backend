...
exports.getAllTestimonials = async (userId) => {
  try {
...
exports.getTestimonial = async ({ userId, docId }) => {
  try {
...
exports.createTestimonial = async ({ userId, file, documentTitle }) => {
  try {
    const patient = await getPatientByUserId(userId);
    if (!patient) {
      return Response.NOT_FOUND({ message: "Patient Record Not Found" });
...
exports.updateTestimonial = async ({ userId, docId, file, documentTitle }) => {
  try {
    const patient = await getPatientByUserId(userId);
    if (!patient) {
      return Response.NOT_FOUND({ message: "Patient Record Not Found" });
...
exports.deleteTestimonial = async ({ userId, documentId }) => {
  try {
    const patient = await getPatientByUserId(userId);
    if (!patient) {
      return Response.NOT_FOUND({ message: "Patient Record Not Found" });
