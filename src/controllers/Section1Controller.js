...
exports.view_section1 = (req, res, next) => {
  ...
  // connectPool.query(
  //   "select * from section1 order by id DESC",
  //   (error, [], fields) => {
  //     if (error) {
  //       return res.render("view_section1", {
...
exports.delete_section1 = (req, res) => {
  ...
  //   if ([].length > 0) {
  //     connectPool.query(
  //       'DELETE FROM section1 WHERE id = "' + id + '" ',
  ...
  //           });
  //         }
  //         var imagePath = "public/upload/section1/" + [][0].image;
...
exports.do_edit_section1 = (req, res) => {
  ...
  //       if (status) {
  //         let sql =
  //           "SELECT * FROM section1 WHERE id = " + req.body.id + " LIMIT 1";
  ...
  //             var sqlupdate =
  //               "UPDATE section1 SET ? WHERE id  = " + req.body.id;
  //             connectPool.query(
  //               sqlupdate,
  //               fieldsToUpdate,
  //               function (error, []) {
  ...
  //                 req.flash(
  //                   "success",
  //                   "Section1 has been updated successfully!"
  //                 );
  //                 return res.redirect("/view_section1");
  //               }
  //             );
